...
public class NewArticle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("utenteId")!= null){//Utente già autenticato
            ...
            Articoli nuovoArticolo = ArticoliFactory.getInstance().createArticle();
            
            request.setAttribute("pid", nuovoArticolo.getPid());
            //A questo punto reindirizzo alla jsp
            request.getRequestDispatcher("/scriviArticolo.html").forward(request,response);
